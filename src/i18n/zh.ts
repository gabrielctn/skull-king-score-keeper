...
export const zh: Strings = {
  ...
  whatsNew: {
    ...
    items: [
      "快速设置现在会显示实际采用的规则；无需打开高级设置即可调整灰胡子双人选项。",
      "回合录入更加清晰：未操作的分数保持隐藏，暂计分有明确标识，折叠的奖励区会显示已记录数量。",
      "首页和结算页现在各自突出一个后续操作；桌面端的确认按钮也会紧邻计分表。",
      "控件采用更清晰的边框和说明标签，更易看清、点按和配合屏幕阅读器使用。",
      "分析选项现在会留在页面布局中，不再遮挡游戏按钮。",
    ],
    close: "知道了",
  },
