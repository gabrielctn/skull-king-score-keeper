...
export const zh: Strings = {
  ...
  whatsNew: {
    ...
    history: {
      ...
      "1.11.2": [
        "地图背景重新铺满整个屏幕，缩小时页面也不再向旁边滑动。",
      ],
      "1.11.1": [
        "删除一场对局，整桌都会删除。",
      ],
      "1.11.0": [
        "应用保持免费且无广告。你也可以为它的 App Store 费用出一份力。",
      ],
      "1.10.2": [
        "在另一部手机上跟看的比分会实时更新。",
      ],
  ...
  rules: {
    ...
    special: [
      ...
      { title: "克拉肯", body: "该墩被摧毁：无人获胜，所有牌放到一边。该墩不计入，也不会发生俘获。请把它记入“无人赢得的墩”。由原本会获胜的玩家领出下一墩。" },
      { title: "白鲸", body: "所有特殊牌失效并落败；最高数字牌获胜（包括王牌花色）。若一墩中只有特殊牌，则无人获胜：该墩作废，并记入“无人赢得的墩”。白鲸墩中不产生特殊牌俘获奖励。" },
